...
func (c *loginClient) UserLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.Login/UserLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLoginServer) UserLogin(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _Login_UserLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Login/UserLogin",
	}
...
var Login_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ezt/grpc/model/ezt-client.proto",
}
